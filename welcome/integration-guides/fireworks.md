...
Portkey also supports function calling mode on Fireworks. [Explore this cookbook for a deep dive and examples](../../guides/practitioners-cookbooks/quickstarts/function-calling.md).
