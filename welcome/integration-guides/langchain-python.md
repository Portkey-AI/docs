...
Portkey's Langchain integration gives you full visibility into the running of an agent. You can replace the `ChatModel` definition as above and Portkey will be able to log the entire workflow.
